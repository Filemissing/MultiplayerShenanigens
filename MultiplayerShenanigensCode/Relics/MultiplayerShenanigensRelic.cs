...
using MultiplayerShenanigens.MultiplayerShenanigensCode.Extensions;
...
namespace MultiplayerShenanigens.MultiplayerShenanigensCode.Relics
{
    ...
    /// </summary>
    public abstract class MultiplayerShenanigensRelic : CustomRelicModel
    {
        //MultiplayerShenanigens/images/relics
        public override string PackedIconPath => $"{Id.Entry.RemovePrefix().ToLowerInvariant()}.png".RelicImagePath();
        protected override string PackedIconOutlinePath => $"{Id.Entry.RemovePrefix().ToLowerInvariant()}_outline.png".RelicImagePath();
        protected override string BigIconPath => $"{Id.Entry.RemovePrefix().ToLowerInvariant()}_big.png".BigRelicImagePath();
    }
}